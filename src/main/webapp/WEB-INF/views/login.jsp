...
<div class="container text-center">
		...
		<div id="Login" class="login-box animated fadeInUp">
			<form:form name="LoginForm" method="post" onsubmit="validate(this);" action="login.submit" modelAttribute="loginBean">
		...
		<script type="text/javascript">
		  document.getElementById('test').innerHTML="Login verifying!!";
		</script>
	<script type="text/javascript">
